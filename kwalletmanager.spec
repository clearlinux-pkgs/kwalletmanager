...
Version  : 19.12.2
Release  : 19
URL      : https://download.kde.org/stable/release-service/19.12.2/src/kwalletmanager-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kwalletmanager-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kwalletmanager-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kwalletmanager-19.12.2
cd %{_builddir}/kwalletmanager-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581032713
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwalletmanager-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kwalletmanager/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kwalletmanager-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwalletmanager/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
