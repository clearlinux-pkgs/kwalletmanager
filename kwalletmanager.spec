...
Version  : 23.04.1
Release  : 55
URL      : https://download.kde.org/stable/release-service/23.04.1/src/kwalletmanager-23.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kwalletmanager-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kwalletmanager-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kwalletmanager-23.04.1
cd %{_builddir}/kwalletmanager-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685630748
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/V3/usr/lib64/libexec/kauth/kcm_kwallet_helper5
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt5/plugins/plasma/kcms/systemsettings_qwidgets/kcm_kwallet5.so
/usr/lib64/qt5/plugins/plasma/kcms/systemsettings_qwidgets/kcm_kwallet5.so
