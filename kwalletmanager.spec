...
Version  : 22.08.0
Release  : 44
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kwalletmanager-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kwalletmanager-22.08.0.tar.xz
...
%prep
%setup -q -n kwalletmanager-22.08.0
cd %{_builddir}/kwalletmanager-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661535078
mkdir -p clr-build
pushd clr-build
