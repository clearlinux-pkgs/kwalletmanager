...
Version  : 21.08.1
Release  : 32
URL      : https://download.kde.org/stable/release-service/21.08.1/src/kwalletmanager-21.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.1/src/kwalletmanager-21.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.1/src/kwalletmanager-21.08.1.tar.xz.sig
...
%prep
%setup -q -n kwalletmanager-21.08.1
cd %{_builddir}/kwalletmanager-21.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630961918
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwalletmanager-21.08.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kwalletmanager/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kwalletmanager-21.08.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kwalletmanager/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
