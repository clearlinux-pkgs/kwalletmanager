...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kwalletmanager-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kwalletmanager-24.08.1.tar.xz.sig
...
%setup -q -n kwalletmanager-24.08.1
cd %{_builddir}/kwalletmanager-24.08.1
pushd ..
cp -a kwalletmanager-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726161823
mkdir -p clr-build
pushd clr-build
