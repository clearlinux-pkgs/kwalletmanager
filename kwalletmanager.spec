...
Version  : 23.08.4
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.4/src/kwalletmanager-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kwalletmanager-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kwalletmanager-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kwalletmanager-23.08.4
cd %{_builddir}/kwalletmanager-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702934867
mkdir -p clr-build
pushd clr-build
