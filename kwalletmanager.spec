...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kwalletmanager-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kwalletmanager-24.12.2.tar.xz.sig
...
%setup -q -n kwalletmanager-24.12.2
cd %{_builddir}/kwalletmanager-24.12.2
pushd ..
cp -a kwalletmanager-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738950587
mkdir -p clr-build
pushd clr-build
