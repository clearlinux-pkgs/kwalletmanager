...
Version  : 24.12.3
Release  : 81
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kwalletmanager-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kwalletmanager-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kwalletmanager-24.12.3.tar.xz.sig
...
%setup -q -n kwalletmanager-24.12.3
cd %{_builddir}/kwalletmanager-24.12.3
pushd ..
cp -a kwalletmanager-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742564919
mkdir -p clr-build
pushd clr-build
