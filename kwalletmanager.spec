...
Source0  : https://download.kde.org/stable/release-service/20.04.0/src/kwalletmanager-20.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.0/src/kwalletmanager-20.04.0.tar.xz.sig
...
%prep
%setup -q -n kwalletmanager-20.04.0
cd %{_builddir}/kwalletmanager-20.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587683346
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwalletmanager-20.04.0/COPYING %{buildroot}/usr/share/package-licenses/kwalletmanager/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kwalletmanager-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwalletmanager/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
